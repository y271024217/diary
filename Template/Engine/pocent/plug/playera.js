...
$(".switch-ksclrc").click(function() {
     ...
     $("#wenkmLrc").hasClass("hide") ? (hasLrc && $songFrom3.html('<i class="fa fa-times-circle"></i> Lrc歌词关闭'), hasKsc && $songFrom3.html('<i class="fa fa-times-circle"></i> Ksc歌词关闭'), wenkmTips.show("歌词显示已关闭"), hasgeci = !1, songFrom33 = "关闭",
                                                  $songFrom4.html('<i class="fa fa-toggle-off" title="打开歌词"></i>')) : (hasLrc && $songFrom3.html('<i class="fa fa-check-circle"></i> Lrc歌词开启'),wenkmTips.show("开启歌词显示"), hasgeci = !0, songFrom33 = "开启", $songFrom4.html('<i class="fa fa-toggle-on" title="关闭歌词"></i>'));
